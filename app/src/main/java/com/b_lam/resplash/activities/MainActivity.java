    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawer = new DrawerBuilder()
                ...
                .addDrawerItems(
                        ...
                        new PrimaryDrawerItem().withName(getString(R.string.main_auto_wallpaper)).withIdentifier(4).withIcon(ThemeUtils.getThemeAttrDrawable(this, R.attr.autoWallpaperIcon)).withSelectable(false).withTextColor(ThemeUtils.getThemeAttrColor(this, R.attr.primaryTextColor)),
                        new DividerDrawerItem(),
